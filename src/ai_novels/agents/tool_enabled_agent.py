...
from ai_novels.agents.base import AgentConfig, AgentState, BaseAgent, Message, MessageType
...
from ai_novels.core.memory_context import MemoryContext
from ai_novels.core.working_memory import AttentionController, WorkingMemory
from ai_novels.llm.tier import ModelTier, TierConfig, TierRouter
from ai_novels.rag.rag_engine import RAGEngine
...
class ToolEnabledAgent(BaseAgent):
    ...
    def _load_default_templates(self) -> None:
        ...
        if defaults is None:
            from ai_novels.agents.prompt_composer import get_default_templates
