...
@file: llm/adapters/qwen.py
@date: 2026-03-12
@author: AI-Novels Team
@version: 1.0
@description: 通义千问API客户端适配器
"""
...
class QwenClient(BaseLLMClient, EmbeddingClient):
    """
    通义千问LLM客户端适配器
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        Args:
            config: Qwen配置
                ...
                - base_url: API地址 (默认: 使用阿里云官方 endpoints)
        ...
        self._model = config.get("model", "qwen-max")
